      ...
      <div className="bg-white p-6 rounded-xl w-full  ">
        ...
        <form onSubmit={formik.handleSubmit}>
                  ...
                  <tr key={mod}>
                    ...
                    {permissionKeys.map((perm) => (
                      <td key={perm} className="p-4 border-b text-center ">
                        <div className="flex justify-center items-center"><ToggleSwitch 

                          checked={
                            formik.values.permissions[mod][
                              perm as keyof (typeof formik.values.permissions)[string]
                            ]
                          }
                          onChange={() =>
          ...
          <div className="flex justify-end gap-3 mt-6">
            ...
            <Button type="submit" className="bg-amber-300 text-black">
