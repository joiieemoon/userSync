...
export default function Pagination({
  ...
  return (
    <div className="flex flex-col gap-4 mt-6">
      {/* Top Section */}
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 w-full p-3">
        {/* Left */}
        ...
        {/* Right */}
        <p className="text-sm text-gray-500 dark:text-gray-400 text-left sm:text-right">
      ...
      <div className="flex flex-wrap items-center justify-center sm:justify-end gap-2">
        <button
          onClick={handlePrev}
          disabled={page === 1}
          className="px-3 py-1.5 text-xs sm:text-sm border rounded-lg dark:border-gray-700 disabled:opacity-50"
        >
          Prev
        </button>
        ...
        {getPages().map((p, index) =>
          p === "..." ? (
            ...
            <button
              ...
              className={`flex items-center justify-center min-w-[32px] h-8 sm:min-w-[40px] sm:h-10 text-xs sm:text-sm font-medium rounded-lg border transition ${
                p === page
